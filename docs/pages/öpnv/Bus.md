# Bus
Der Bus ist einer der Verkehrsmittel, welches einen schnell von A nach B bringen kann.

## Allgemeines
Der Bus transportiert einen Spieler von einer Bushaltestelle bis zur Nächsten. Die übrige Fahrtzeit kannst du durch Drücken von Shift+F einsehen. (Info: In einem Bus wird kein RP gemacht, auch kann im Bus kein Spieler Schaden erhalten und verteilen!). Um mit dem Bus zu fahren, geht man in den Bus und drückt Rechtsklick auf den Busfahrer. Dann kann man sein gewünschtes Reiseziel auswählen.
