# Erfolge
Auf dem Server gibt es verschiedene Erfolge, welche die unterschiedlichen Wege auf GermanRP aufzeigen, die beschritten werden können. Ebenso ist das Erkunden gefragt, da einige Erfolge versteckt sind.
...
|         Lizenz zum Töten?        |         Beantrage einen [Waffenschein](../../pages/allgemein/lizenzen.md)        |    Erwirb einen Waffenschein im [Rathaus](../../pages/orte/rathaus.md).   |
...
|        Hier gehör' ich hin       |           Tritt einer [Fraktion](../../pages/fraktionen/allgemein.md) bei          |   Bewirb dich für eine Fraktion im [Forum](https://germanrp.eu/forum/index.php?board/15-fraktionen/). |
|     Die Karriereleiter hinauf    |           Erhalte eine Beförderung          |   Bekomme eine Beförderung in einer Fraktion.   |
|  I'm the Boss now!  |  Werde als Fraktionsleader freigeschaltet  | Steige in einer Fraktion bis ins Leaderteam auf und steige bei Kapazität und Kompetenz als Co-Leader auf. |
|   Trautes Heim                   |    Kaufe ein [Haus](../../pages/houses/allgemein.md)                           |    Erwirb ein freies Haus mit /buyhouse [Nummer].    |
|      Meine kleine Unterkunft     |             Miete in einem [Haus](../../pages/houses/allgemein.md)             |  Frage einen Hausbesitzer nach einem Mietvertrag.   |
|      Nach dem Familienrezept     |      Koche etwas in deinem Haus/deiner Wohnung     |   Erwirb ein Haus oder eine Wohnung und koche [Essen](../../pages/allgemein/essen.md) aus dem [Supermarkt](../../pages/biz/supermarkt.md).  |
|           Ja, ich will           |          Gehe den Bund der Ehe ein          |    Heirate im [Rathaus](../../pages/orte/rathaus.md) einen Spieler.   |
|    Stirb Kartoffel!   |   Setze ein [Kopfgeld](../../pages/fraktionen/kopfgeld.md) auf einen Spieler aus   |   Erreiche [Spielerlevel](../../pages/allgemein/level.md) 5. Setze mit /kopfgeld [Name] ein Kopfgeld auf einen Spieler aus. |
...
| Zu Risiken und Nebenwirkungen... |       Lasse dir ein [Rezept](../../pages/krankheiten/rezepte.md) ausstellen       |  Sprich einen [Medic](../../pages/fraktionen/rettungsdienst.md) auf Schmerzmittelrezepte an.  |
|            Findet Nemo           |      Finde beim [Angeln](../../pages/nebenjobs/angler.md) einen Clownfisch     |   Angle an allen Gewässern.  |
|   My Money don't jiggle jiggle   |  Breche einen [ATM](../../pages/orte/banken.md) mit einer [Brechstange](../../pages/items/brechstange.md) auf |   Erwirb eine Brechstange in der [Schwarzmarktauktion](../../pages/orte/schwarzmarkt.md) und schlage damit auf einen ATM ein.  |
...
|           Das gute Zeug          |     Konsumiere zum ersten Mal [Novapulver](../../pages/bmt/novapulver.md)    |                           Sprich einen Crimefrakler an und erwirb Novapulver.     |
...
|       Rehabiliert, oder so       |    Werde per Kaution aus der Haft befreit   |           Jemand kauft dich per **/kaution** in der Eingangshalle der [JVA](../../pages/orte/jva.md) frei.  |
...
|           Klopf, klopf!          |              Klopfe an eine Tür             |                Betätige die Offhandtaste (standardmäßig ++f++) und schaue eine Tür an. |
|      Zusammen geht's besser      |          Sei Teil einer [Gruppierung](../../pages/allgemein/gruppierung.md)         | 
|          Vorsicht giftig         |           [Angel](../../pages/nebenjobs/angler.md) einen Pufferfisch           |                                       Angle an Flüssen und Teichen.                |
|        Versteckter Erfolg        |                     ???                     |    Erkunde den Server.      |
...
|           Nur das Beste          |  Konsumiere zum ersten Mal eine [Mohnkapsel](../../pages/bmt/mohnkapseln.md)  |                         Sprich einen [Crimefrakler](../../pages/fraktionen/allgemein.md) an und erwirb eine Mohnkapsel.   |
|        Feelin' like Snoop        |     Konsumiere zum ersten Mal [Heilkraut](../../pages/bmt/heilkraut.md)     |                            Sprich einen Crimefrakler an und erwirb Heilkraut.      |
|     Schnurrt wie ein Kätzchen    |    Repariere zum ersten Mal ein [Fahrzeug](../../pages/fahrzeuge/allgemein.md)    |                  Fahre dein Fahrzeug zu einer [KFZ-Werkstatt](../../pages/fahrzeuge/kfz-werkstatt.md) und repariere es beim NPC.  |
...
|           Gut geschützt          |     Lasse dich vom [Rettungsdienst](../../pages/fraktionen/rettungsdienst.md) [impfen](../../pages/krankheiten/impfung.md)    |                    Sprich einen Medic im Krankenhaus auf eine Grippeschutzimpfung an. |
|        Stylisch unterwegs        |     Füge einen Skin zur Garderobe hinzu     |            Gib **/garderobe** in deinem Haus oder Auto ein und füge einen Skin hinzu.  |
...
|       We are the Champions       |            Gewinne einen [Gangwar](../../pages/fraktionen/gangwar.md)            |          Nimm mit einer [Crimefraktion](../../pages/fraktionen/allgemein.md) an einem Gangwar teil und gewinne diesen.  |
| Man kann's ja mal probieren! | Nimm an einem [Streetrace](../../pages/fraktionen/streetrace.md) teil | Begib dich zum Startpunkt des Streetraces. |
| Ich bin der Schnellste! | Gewinne ein Streetrace | Werde Erster im Rennen. |
